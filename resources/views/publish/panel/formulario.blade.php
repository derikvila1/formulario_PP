...
<body>
    <main>
        ...
        <a href="https://cultura.am.gov.br/espacos-culturais/museus/palacete-provincial/">
            <img class="imagePalacete" src="/img/palacete.webp" a  alt="">
        </a>
        </section>
        <h1 class="titlePalacete">Palacete Provincial</h1>
        <!--Idiomas div-->
        <section id="idiomas">
        ...
        <!--Titulo 1-->
        <section id="titulos">
            <h2 style="margin-bottom:2rem;" class="Idioma-titulo titulo-BR color-titulos">Gostaríamos de obter seu grau de satisfação em relação à experiência de conhecer um dos nossos maiores patrimônios históricos e culturais. Vamos lá?</h2>
        </section>
        <!--Form-->
        ...
        @csrf
            ...
            <section class="radios">
                ...
                <section id="Condutores/Visitação">
                        <h3 style="font-size:30px; padding-top: 1rem;" class="p-padrao condutores form-titulo">Condutores/Visitação</h3>
